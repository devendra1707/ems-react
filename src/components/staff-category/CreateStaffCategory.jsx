...
import { saveStaffCategory } from "../../services/StaffCategoryService";
const CreateStaffCategory = () => {
  ...
  const handleSubmit = (event) => {
    ...
    saveStaffCategory(staffCategory)
      .then((data) => {
        navigate("/staff-category");
      })
      .catch((error) => {
        console.log("Failed to Save StaffCategory. Please try again later.");
        console.log(error);
      });
  };
...
export default CreateStaffCategory;
