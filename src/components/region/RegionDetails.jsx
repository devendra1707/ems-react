...
import { deleteRegionById, fetchRegionList } from "../../services/RegionService";
  ...
  const handleDelete = (regionId) => {
    deleteRegionById(regionId)
      .then(() => {
        ...
        setRegion((prev) => prev.filter((g) => g.regionId !== regionId));
      })
      .catch((error) => {
        alert("This is mapped with another entry: " + regionId);
          ...
          <div className="card border-0">
            <div className="card-header bg-light">
              <div className="d-flex align-items-center justify-content-center position-relative">
                ...
                <h5 className="card-title mb-0">Region Details</h5>
              </div>
            </div>
                          ...
                          <td>
                            <div className="d-flex gap-2">
                              <button
                                ...
                                onClick={() =>
                                  navigate(`/edit-region/${details.regionId}`)
                                }
                              >
                                <FiEdit />
                              </button>
                              <button
                                ...
                                onClick={() => handleDelete(details.regionId)}
                              >
                                <MdDeleteForever />
                              </button>
                            </div>
