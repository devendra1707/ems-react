...
import { saveReservationClasification } from "../../services/ReservationClasificationService";
const CreateReservationClassification = () => {
  ...
  const handleSubmit = (event) => {
    ...
    saveReservationClasification(reservationClassification)
      .then((data) => {
        navigate("/reservation-clasification");
      })
      .catch((error) => {
        console.log("Failed to Save ReservationClassification. Please try again later.");
        console.log(error);
      });
  };

  const handleReset = () => {
    setReservationClassification({
      title: "",
    });
  };
  return (
    ...
    <main className="content px-5 py-2">
      <div className="container-fluid mt-3">
        <div className="text-center">
          <i>
            <h3>Create Reservation Classification</h3>
          </i>
        </div>
...
export default CreateReservationClassification